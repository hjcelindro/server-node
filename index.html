    <head>
        ...
        <script type="text/javascript">
            ...
            socket.on('mqtt',function(msg){
                ...
                $('table').append('<tr id="'+id+'" ><td>'+id+'</td><br><td>'+String(msg.payload.location)+'</td><br><td>'+String(msg.payload.manufacturer)+'</td><br><td>'+String(msg.payload.message)+'</td><br><td align="center"><form><input type=button id="collect" value="Collect" style="width:40%" onclick="getItem()"></form></td></tr>');
